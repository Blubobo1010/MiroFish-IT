"""
Logger delle azioni
Per registrare le azioni di ogni Agent nella simulazione OASIS, a uso del monitoraggio backend
...
class PlatformActionLogger:
    """Logger azioni per singola piattaforma"""
    ...
    def __init__(self, platform: str, base_dir: str):
        ...
        Args:
            ...
            base_dir: percorso base della directory di simulazione
        """
    ...
    def log_round_start(self, round_num: int, simulated_hour: int):
        """Registrare l'inizio di un turno"""
        entry = {
            "round": round_num,
            "timestamp": datetime.now().isoformat(),
    ...
    def log_round_end(self, round_num: int, actions_count: int):
        """Registrare la fine di un turno"""
        entry = {
            "round": round_num,
            "timestamp": datetime.now().isoformat(),
    ...
    def log_simulation_start(self, config: Dict[str, Any]):
        """Registrare l'inizio della simulazione"""
        entry = {
            "timestamp": datetime.now().isoformat(),
    ...
    def log_simulation_end(self, total_rounds: int, total_actions: int):
        """Registrare la fine della simulazione"""
        entry = {
            "timestamp": datetime.now().isoformat(),
...
class SimulationLogManager:
    """
    Gestore log della simulazione
    Gestisce in modo unificato tutti i file di log, separati per piattaforma
    """

    def __init__(self, simulation_dir: str):
        """
        Inizializzare il gestore log
        ...
        # Configurare il log principale
        self._setup_main_logger()

    def _setup_main_logger(self):
        """Configurare il log principale della simulazione"""
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Ottenere il logger della piattaforma Twitter"""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Ottenere il logger della piattaforma Reddit"""
...
# ============ Compatibilita' vecchia interfaccia ============

class ActionLogger:
    """
    Logger delle azioni (compatibilita' vecchia interfaccia)
    Si consiglia di usare SimulationLogManager al suo posto
    """
...
# Istanza logger globale (compatibilita' vecchia interfaccia)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Ottenere l'istanza logger globale (compatibilita' vecchia interfaccia)"""
